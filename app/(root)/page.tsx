  ...
  return (
    <>
      ...
      <div className="hero-bg mx-auto max-w-screen-xl px-4 animate-fadeIn">
        <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-semibold text-center mb-8 px-4">
          Greetings from the Heart!
        </div>
      </div>

      <hr className="border-t-2 border-dark-100 my-6 md:my-8 mx-auto max-w-screen-xl" />
      ...
      <div className="flex justify-center px-4">
        ...
        >
          <div className="bg-light-400 rounded-xl shadow-lg flex flex-col md:flex-row items-center w-full max-w-7xl mx-auto px-4 sm:px-8 md:px-12 lg:px-16 py-8 md:py-14 gap-6 md:gap-12">
            <div className="flex-1 w-full">
              <h1 className="font-bebas-neue text-2xl sm:text-3xl md:text-4xl text-dark-900 mb-4 text-center md:text-left">
                SANBRY MEN GROOMING HOUSE SERVICES
              </h1>
              <h2 className="font-bebas-neue text-base sm:text-lg text-dark-900 mb-6 text-center md:text-left">
      ...
      <div className="flex justify-center px-4 mb-8">
        ...
        >
          <div className="bg-light-400 rounded-xl shadow-lg flex flex-col md:flex-row items-center w-full max-w-6xl mx-auto px-4 sm:px-8 md:px-12 lg:px-16 py-8 md:py-14 gap-6 md:gap-12">
            <div className="flex-1 w-full">
              <h1 className="font-bebas-neue text-2xl sm:text-3xl md:text-4xl text-dark-900 mb-4 text-center md:text-left">
