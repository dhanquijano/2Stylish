...
const AppointmentForm = () => {
  ...
  const checkAvailability = async () => {
    ...
    try {
      ...
      console.log('[checkAvailability] API Response:', result);
      console.log('[checkAvailability] Time slots received:', result.data?.timeSlots);
      console.log('[checkAvailability] Unavailable slots:', result.data?.timeSlots?.filter((s: any) => !s.available));
  ...
  return (
    <div className="flex flex-col gap-4 sm:gap-6 max-w-2xl mx-auto px-4 sm:px-0">
